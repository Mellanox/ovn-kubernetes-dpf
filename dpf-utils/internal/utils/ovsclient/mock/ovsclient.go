...
//
//	mockgen -copyright_file /Users/hareeshp/dev/dpf/doca-platform-foundation/hack/boilerplate.go.txt -destination mock/ovsclient.go -source types.go
//
...
import (
	...
	ovsclient "github.com/nvidia/ovn-kubernetes-components/internal/utils/ovsclient"
...
func (mr *MockOVSClientMockRecorder) SetHostName(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
